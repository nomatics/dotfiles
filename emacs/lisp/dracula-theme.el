...
(let ((colors '((fg1          "#f8f8f2")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
      ...
      (faces '(;; default
               ...
               (term-color-blue :foreground ,deepSkyBlue :background ,deepSkyBlue)
               (term-color-cyan :foreground ,cyan :background ,cyan)
               (term-color-green :foreground ,lawnGreen :background ,lawnGreen)
               (term-color-magenta :foreground ,mediumOrchid :background ,mediumOrchid)
               (term-color-red :foreground ,indianRed :background ,indianRed)
               (term-color-white :foreground ,fg2 :background ,fg2)
               (term-color-yellow :foreground ,khaki1 :background ,khaki1)
               ;; undo-tree
